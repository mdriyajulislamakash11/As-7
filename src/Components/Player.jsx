        ...
        <div className="border-2  mt-4 ">
            <div className="card bg-base-100  shadow-xl">
                ...
                <div className="card-body ">
                    <h2 className="card-title text-lg font-extrabold mb-3"><i className="fa-solid fa-user-large text-2xl mr-4"></i>  {name}</h2>
                   <div className="flex items-center">
                   <p className=""><i className="fa-brands fa-font-awesome text-lg mr-4"></i> {country}</p>
